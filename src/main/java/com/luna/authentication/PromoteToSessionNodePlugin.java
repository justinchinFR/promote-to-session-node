 ...
 */
public class PromoteToSessionNodePlugin extends AbstractNodeAmPlugin {
     ...
     */
    @Inject
    public PromoteToSessionNodePlugin(AnnotatedServiceRegistry serviceRegistry) {
